...
def master_pipelines(edition):
    ...
    if edition != 'enterprise':
        ...
        pipelines.append(notify_pipeline(
            name='notify-master', slack_channel='grafarg-ci-notifications', trigger=trigger,
        ...
        pipelines.append(notify_pipeline(
            name='notify-master-downstream', slack_channel='grafarg-enterprise-ci-notifications', trigger=trigger,
