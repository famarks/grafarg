...
func TestPreparingReleaseFromRemote(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			expectedArch:    "amd64",
			expectedOs:      "linux",
			expectedURL:     "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg-5.2.0-beta1.linux-amd64.tar.gz",
			baseArchiveURL:  "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg",
		...
		},
		{
			...
			expectedArch:    "amd64",
			expectedOs:      "rhel",
			expectedURL:     "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg-5.2.3-1.x86_64.rpm",
			baseArchiveURL:  "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg",
		...
		},
		{
			...
			expectedArch:    "amd64",
			expectedOs:      "rhel",
			expectedURL:     "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg-5.4.0~pre1asdf-1.x86_64.rpm",
			baseArchiveURL:  "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg",
			buildArtifacts:  []buildArtifact{{"rhel", "amd64", ".x86_64.rpm", ""}},
		},
		{
			...
			expectedArch:    "armv6",
			expectedOs:      "deb",
			expectedURL:     "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg-rpi_5.4.0~pre1asdf_armhf.deb",
			baseArchiveURL:  "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg",
			buildArtifacts: []buildArtifact{
		...
		},
		{
			...
			expectedURL:     "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg-5.4.0-pre1asdf.windows-amd64.msi",
			baseArchiveURL:  "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg",
		...
		},
		{
			...
			expectedArch:    "amd64",
			expectedOs:      "win",
			expectedURL:     "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg-5.4.0-pre1asdf.windows-amd64.zip",
			baseArchiveURL:  "https://s3-us-west-2.amazonaws.com/grafarg-releases/release/grafarg",
