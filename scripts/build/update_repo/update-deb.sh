...
RELEASE_TAG="${3:-}"
DIST_PATH="${4:-}"
GCP_DB_BUCKET="${5:-grafarg-aptly-db}"
...
rm /deb-repo/tmp/grafarg_latest*.deb || true
...
aptly publish update stable filesystem:repo:grafarg
aptly publish update beta filesystem:repo:grafarg
