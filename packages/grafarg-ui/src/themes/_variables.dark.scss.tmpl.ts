...
export const darkThemeVarsTemplate = (theme: GrafargTheme) =>
  `${renderGeneratedFileBanner('grafarg-ui/src/themes/dark.ts', 'grafarg-ui/src/themes/_variables.dark.scss.tmpl.ts')}
// Global values
// --------------------------------------------------
