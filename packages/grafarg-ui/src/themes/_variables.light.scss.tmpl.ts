...
export const lightThemeVarsTemplate = (theme: GrafargTheme) =>
  `${renderGeneratedFileBanner('grafarg-ui/src/themes/light.ts', 'grafarg-ui/src/themes/_variable.light.scss.tmpl.ts')}
// Global values
// --------------------------------------------------
