...
export const calculateListSizes = (theme: GrafargTheme, allItems: CompletionItem[], longestLabel: string) => {
...
export const calculateItemHeight = (longestLabelHeight: number, theme: GrafargTheme) => {
...
export const calculateListWidth = (longestLabelWidth: number, theme: GrafargTheme) => {
