...
One example of the Drawer in use is in Grafarg's [panel inspector](https://grafarg.com/docs/grafarg/latest/panels/inspect-panel/).

### Usage
```tsx
import { Drawer } from '@grafarg/ui';
