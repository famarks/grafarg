...
function getButtonVariantStyles(from: string, to: string, textColor: string, theme: GrafargTheme) {
  return css`
...
export function getPropertiesForVariant(theme: GrafargTheme, variant: ButtonVariant) {
  switch (variant) {
    case 'secondary':
