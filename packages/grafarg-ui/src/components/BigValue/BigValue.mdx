...
# BigValue
Component for showing a value based on a [DisplayValue](https://grafarg.com/docs/grafarg/latest/packages_api/data/displayvalue/#displayvalue-interface).
...
### Example usage
An example usage is in the [Stat panel](https://grafarg.com/docs/grafarg/latest/panels/visualizations/stat-panel/).

```tsx
import { DisplayValue } from '@grafarg/data';
import {
  BigValue,
  BigValueColorMode,
  BigValueGraphMode,
