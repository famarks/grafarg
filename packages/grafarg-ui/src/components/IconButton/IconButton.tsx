...
function getHoverColor(theme: GrafargTheme, surface: SurfaceType): string {
  switch (surface) {
    case 'dashboard':
...
const getStyles = stylesFactory((theme: GrafargTheme, surface: SurfaceType, size: IconSize) => {
