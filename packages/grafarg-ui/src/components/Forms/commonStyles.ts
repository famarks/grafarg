...
export const getFocusStyle = (theme: GrafargTheme) => css`
  &:focus {
    ${focusCss(theme)}
  }
`;

export const sharedInputStyle = (theme: GrafargTheme, invalid = false) => {
...
export function getPropertiesForButtonSize(size: ComponentSize, theme: GrafargTheme) {
