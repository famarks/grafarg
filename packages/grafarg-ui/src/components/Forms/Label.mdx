...
This label component is used in full-page forms in Grafarg, for example in the datasource settings. In some parts of Grafarg, there are inline forms which do not use this type of label.
