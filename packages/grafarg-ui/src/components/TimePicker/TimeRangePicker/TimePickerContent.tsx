...
const getStyles = stylesFactory((theme: GrafargTheme, isReversed, hideQuickRanges, isContainerTall) => {
...
const getNarrowScreenStyles = stylesFactory((theme: GrafargTheme) => {
  return {
    header: css`
      display: flex;
      flex-direction: row;
...
const getFullScreenStyles = stylesFactory((theme: GrafargTheme, hideQuickRanges?: boolean) => {
  return {
    container: css`
      padding-top: 9px;
      padding-left: 11px;
...
const getEmptyListStyles = stylesFactory((theme: GrafargTheme) => {
    ...
    <div className={styles.container}>
      ...
      <div>
        <a
          ...
          href="https://grafarg.com/docs/grafarg/latest/dashboards/time-range-controls"
          target="_new"
        >
