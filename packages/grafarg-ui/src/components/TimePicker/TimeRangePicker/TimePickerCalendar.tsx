...
import { dateTime, DateTime, dateTimeParse, GrafargTheme, TimeZone } from '@grafarg/data';
...
const getStyles = stylesFactory((theme: GrafargTheme, isReversed = false) => {
...
const getFooterStyles = stylesFactory((theme: GrafargTheme) => {
  return {
    container: css`
      background-color: ${theme.colors.bodyBg};
      display: flex;
...
const getBodyStyles = stylesFactory((theme: GrafargTheme) => {
  return {
    title: css`
...
const getHeaderStyles = stylesFactory((theme: GrafargTheme) => {
  return {
    container: css`
      background-color: ${theme.colors.bodyBg};
      display: flex;
