...
export const logo = 'https://grafarg.com/static/assets/img/apple-touch-icon.png'
...
<Card heading="Test dashboard">
   <Card.Meta>
    Grafarg
    <a key='prom-link' href="https://ops-us-east4.grafarg.net/api/prom">https://ops-us-east4.grafarg.net/api/prom</a>
    </Card.Meta>
</Card>
```
...
### Tags
Tags can be rendered inside the Card, by being wrapped in `Card.Tags` component. Note that this component does not provide any tag styling and that should be handled by the children. It is recommended to use it with Grafarg-UI's `TagList` component.
...
```jsx
<Card
  heading="Redirect to Grafarg"
  description="Clicking this card will redirect to grafarg website"
