 ...
 * @public
 */
export const getContainerStyles = stylesFactory((theme: GrafargTheme, disabled = false, disableHover = false) => {
  return css`
    display: flex;
    width: 100%;
 ...
 * @public
 */
export const getCardStyles = stylesFactory((theme: GrafargTheme) => {
  return {
    inner: css`
      display: flex;
