...
export interface InfoBoxProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title'> {
  ...
  urlTitle?: string;
  /** Indicates whether or not box should be rendered with Grafarg branding background */
  branded?: boolean;
...
const getInfoBoxStyles = stylesFactory((theme: GrafargTheme, severity: AlertVariant) => ({
  wrapper: css`
    position: relative;
