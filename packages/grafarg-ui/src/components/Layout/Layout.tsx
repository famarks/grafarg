...
const getStyles = stylesFactory(
  (theme: GrafargTheme, orientation: Orientation, spacing: Spacing, justify: Justify, align, wrap) => {
...
const getContainerStyles = stylesFactory((theme: GrafargTheme, padding?: Spacing, margin?: Spacing) => {
