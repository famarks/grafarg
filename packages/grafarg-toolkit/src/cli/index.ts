...
export const run = (includeInternalScripts = false) => {
  if (includeInternalScripts) {
    ...
    program
      ...
      .description('Starts Grafarg front-end in development mode with watch enabled')
      .action(async (cmd) => {
    ...
    program
      ...
      .description('Builds @grafarg/* package to packages/grafarg-*/dist')
      .action(async (cmd) => {
    ...
    program
      .command('cherrypick')
      .option('-e, --enterprise', 'Run task for grafarg-enterprise')
    ...
    program
      ...
      .description('Prepares grafarg/toolkit dist package')
      .action(async (cmd) => {
  ...
  program
    ...
    .option('--yarnlink', 'symlink this project to the local grafarg/toolkit')
