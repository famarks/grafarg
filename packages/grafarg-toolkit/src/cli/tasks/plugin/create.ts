...
const RepositoriesPaths: Record<PluginType, string> = {
  'panel-plugin': 'https://github.com/famarks/simple-react-panel.git',
  'datasource-plugin': 'https://github.com/famarks/simple-datasource.git',
  'backend-datasource-plugin': 'https://github.com/famarks/simple-datasource-backend.git',
};
