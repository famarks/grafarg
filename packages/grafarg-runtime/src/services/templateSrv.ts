 ...
 *
 * For a more in-depth description visit: https://grafarg.com/docs/grafarg/latest/reference/templating
 * @public
 */
...
/**
 * Used during startup by Grafarg to set the TemplateSrv so it is available
