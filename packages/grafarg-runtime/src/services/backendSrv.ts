...
/**
 * Used to communicate via http(s) to a remote backend such as the Grafarg backend,
 ...
 *
 * @remarks
 * By default, Grafarg displays an error message alert if the remote call fails. To prevent this from
...
export interface BackendSrv {
   ...
   * events that the Grafarg QueryInspector and QueryEditor is listening for to be able
...
/**
 * Used during startup by Grafarg to set the BackendSrv so it is available
 ...
 * via http(s) to a remote backend such as the Grafarg backend, a datasource etc.
 *
 * @public
 */
