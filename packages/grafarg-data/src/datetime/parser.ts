...
export interface DateTimeOptionsWhenParsing extends DateTimeOptions {
  /**
   * If the input is a Grafarg quick date, e.g. now-6h, then you can specify this to control
 ...
 *
 * It can also parse the Grafarg quick date and time format, e.g. now-6h will be parsed as Date.now() - 6 hours and
