...
import { MatcherConfig, FieldConfig, Field, DataFrame, GrafargTheme, TimeZone } from '../types';
...
/**
 * Describes config override rules created when interacting with Grafarg.
 *
 * @internal
 */
