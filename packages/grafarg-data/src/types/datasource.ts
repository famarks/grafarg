...
import { GrafargPlugin, PluginMeta } from './plugin';
...
export class DataSourcePlugin<
  ...
  TSecureOptions = {}
> extends GrafargPlugin<DataSourcePluginMeta<TOptions>> {
...
export interface DataQueryResponse {
   ...
   * Use this key to inform Grafarg how to combine the partial responses
