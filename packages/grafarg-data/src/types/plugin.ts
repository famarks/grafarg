...
/** Describes {@link https://grafarg.com/docs/grafarg/latest/plugins | type of plugin} */
...
/** Describes status of {@link https://grafarg.com/docs/grafarg/latest/plugins/plugin-signatures/ | plugin signature} */
...
/** Describes error code returned from Grafarg plugins API call */
...
/** Describes error returned from Grafarg plugins API call */
...
export class GrafargPlugin<T extends PluginMeta = PluginMeta> {
