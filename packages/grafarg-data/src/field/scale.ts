...
import { Field, FieldConfig, FieldType, GrafargTheme, NumericRange, Threshold } from '../types';
...
export function getScaleCalculator(field: Field, theme: GrafargTheme): ScaleCalculator {
