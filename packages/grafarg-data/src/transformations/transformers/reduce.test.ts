...
describe('Reducer Transformer', () => {
  ...
  it('reduces multiple data frames with decimal display name (https://github.com/famarks/grafarg/issues/31580)', async () => {
    const cfg = {
      id: DataTransformerID.reduce,
      options: {
  ...
  it('reduces multiple data frames with decimal fields name (https://github.com/famarks/grafarg/issues/31580)', async () => {
    const cfg = {
      id: DataTransformerID.reduce,
      options: {
        reducers: [ReducerID.max],
