    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function measureTickLabels(axis) {
            ...
            for (var i = 0; i < ticks.length; ++i) {
                ...
                /// Grafarg fix, add +1 to label width
        ...
        function setRange(axis) {
            ...
            if (delta == 0.0) {
                // Grafarg fix: wide Y min and max using increased wideFactor
        ...
        // grafarg addon - added to support mobile devices click in plot
        function onTouch(e) {
            if (!e.cancelable) {
                return;
            }
        ...
        // grafarg addon - added to support mobile devices and mapping touch event to click event structure
