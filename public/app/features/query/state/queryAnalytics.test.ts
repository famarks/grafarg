import { MetaAnalyticsEventName, reportMetaAnalytics } from '@grafarg/runtime';
import { CoreApp, DataQueryRequest, DataSourceApi, dateTime, LoadingState, PanelData } from '@grafarg/data';
...
jest.mock('@grafarg/runtime', () => ({
  ...(jest.requireActual('@grafarg/runtime') as any),
