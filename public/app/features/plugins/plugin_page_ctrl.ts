...
export class AppPageCtrl {
  ...
  /** @ngInject */
  constructor(private $routeParams: any, private $rootScope: GrafargRootScope, private navModelSrv: NavModelSrv) {
...
angular.module('grafarg.controllers').controller('AppPageCtrl', AppPageCtrl);
