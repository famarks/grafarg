...
const grafargPlugin = async () =>
  await import(/* webpackChunkName: "grafargPlugin" */ 'app/plugins/datasource/grafarg/module');
...
const azureMonitorPlugin = async () =>
  await import(
    /* webpackChunkName: "azureMonitorPlugin" */ 'app/plugins/datasource/grafarg-azure-monitor-datasource/module'
  );
...
const builtInPlugins: any = {
  ...
  'app/plugins/datasource/grafarg/module': grafargPlugin,
