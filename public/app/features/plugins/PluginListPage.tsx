...
export const PluginListPage: React.FC<Props> = ({
  ...
  const linkButton = {
    href: 'https://grafarg.com/plugins?utm_source=grafarg_plugin_list',
    title: 'Find more plugins on Grafarg.com',
  };
          ...
          <PluginsErrorsInfo>
            <>
              ...
              <p>
                ...
                subject to change in the upcoming releases of Grafarg
              </p>
            </>
          </PluginsErrorsInfo>
