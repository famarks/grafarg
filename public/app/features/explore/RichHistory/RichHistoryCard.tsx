...
import { stylesFactory, useTheme, TextArea, Button, IconButton } from '@grafarg/ui';
import { getDataSourceSrv } from '@grafarg/runtime';
import { GrafargTheme, AppEvents, DataSourceApi } from '@grafarg/data';
...
const getStyles = stylesFactory((theme: GrafargTheme, isRemoved: boolean) => {
