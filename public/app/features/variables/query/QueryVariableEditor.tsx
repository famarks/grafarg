      ...
      <VerticalGroup spacing="xs">
        ...
        <VerticalGroup spacing="lg">
            ...
            <VariableTextField
              ...
              tooltip={
                <div>
                  ...
                  <a
                    href="https://grafarg.com/docs/grafarg/latest/variables/filter-variables-with-regex#filter-and-modify-using-named-text-and-value-capture-groups"
                    target="__blank"
                  >
                    see examples
                  </a>
          ...
          <VerticalGroup spacing="none">
            ...
            <em className="muted p-b-1">Experimental feature, will be deprecated in Grafarg v8.</em>
