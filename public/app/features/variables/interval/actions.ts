...
export const updateAutoValue = (
  ...
  if (variableInState.auto) {
    ...
    dependencies.templateSrv.setGrafargVariable('$__auto_interval_' + variableInState.name, res.interval);
    // for backward compatibility, to be removed eventually
    dependencies.templateSrv.setGrafargVariable('$__auto_interval', res.interval);
  }
};
