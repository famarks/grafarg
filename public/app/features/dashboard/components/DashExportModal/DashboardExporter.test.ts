...
import { PanelPluginMeta } from '@grafarg/data';
...
describe('given dashboard with repeated panels', () => {
  ...
  it('should add grafarg version', () => {
    const require: any = _.find(exported.__requires, { name: 'Grafarg' });
    expect(require.type).toBe('grafarg');
    expect(require.id).toBe('grafarg');
