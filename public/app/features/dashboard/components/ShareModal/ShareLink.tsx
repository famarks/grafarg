...
import { Field, RadioButtonGroup, Switch, ClipboardButton, Icon, InfoBox, Input, FieldSet } from '@grafarg/ui';
import { SelectableValue, PanelModel, AppEvents } from '@grafarg/data';
            ...
            {panel && !config.rendererAvailable && (
              <InfoBox>
                <p>
                  ...
                  <a
                    href="https://grafarg.com/grafarg/plugins/grafarg-image-renderer"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="external-link"
                  >
                    Grafarg Image Renderer plugin
                  </a>
                  . Please contact your Grafarg administrator to install the plugin.
                </p>
              </InfoBox>
            )}
          </div>
