...
import { RadioButtonGroup, Switch, Field, TextArea, ClipboardButton } from '@grafarg/ui';
import { SelectableValue, AppEvents } from '@grafarg/data';
          ...
          <div className="share-modal-content">
            ...
            <Field
              ...
              description="The html code below can be pasted and included in another web page. Unless anonymous access is enabled, 
                the user viewing that page need to be signed into grafarg for the graph to load."
            >
