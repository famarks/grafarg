...
import { Modal, ConfirmModal, HorizontalGroup, Button } from '@grafarg/ui';
...
const ProvisionedDeleteModal = ({ hideModal, provisionedId }: { hideModal(): void; provisionedId: string }) => (
  ...
  >
    <p>
      This dashboard is managed by Grafargs provisioning and cannot be deleted. Remove the dashboard from the config
      file to delete it.
    </p>
    <p>
      <i>
        ...
        <a
          ...
          href="http://docs.grafarg.org/administration/provisioning/#dashboards"
          target="_blank"
          rel="noreferrer"
        >
          documentation
