...
import { AppEvents, dateMath, UrlQueryValue } from '@grafarg/data';
...
export class DashboardLoaderSrv {
  ...
  constructor(
    ...
    private $rootScope: GrafargRootScope
  ) {}
...
angular.module('grafarg.services').service('dashboardLoaderSrv', DashboardLoaderSrv);
