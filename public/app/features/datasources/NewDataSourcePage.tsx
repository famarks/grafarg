    ...
    return (
      <>
        ...
        <div className="add-data-source-more">
          <LinkButton
            variant="secondary"
            href="https://grafarg.com/plugins?type=datasource&utm_source=grafarg_add_ds"
            target="_blank"
            rel="noopener"
          >
            Find more data source plugins on grafarg.com
          </LinkButton>
        </div>
      </>
    );
            ...
            <PluginsErrorsInfo>
              <>
                ...
                <p>
                  ...
                  to change in the upcoming releases of Grafarg
                </p>
              </>
            </PluginsErrorsInfo>
          )}
      ...
      actions={
        <>
          {learnMoreLink && (
            <LinkButton
              variant="secondary"
              href={`${learnMoreLink.url}?utm_source=grafarg_add_ds`}
              target="_blank"
              rel="noopener"
