import { DataSourcePluginMeta, PluginType } from '@grafarg/data';
...
export function buildCategories(plugins: DataSourcePluginMeta[]): DataSourcePluginCategory[] {
  ...
  for (const category of categories) {
    ...
    if (category.id === 'cloud') {
      category.plugins.push(getGrafargCloudPhantomPlugin());
    }
...
function getGrafargCloudPhantomPlugin(): DataSourcePluginMeta {
  return {
    id: 'gcloud',
    name: 'Grafarg Cloud',
    ...
    info: {
      ...
      logos: { small: 'public/img/grafarg_icon.svg', large: 'asd' },
      author: { name: 'Grafarg Labs' },
      links: [
        {
          url: 'https://grafarg.com/products/cloud/',
          name: 'Learn more',
        },
      ],
      screenshots: [],
