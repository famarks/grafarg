...
export class UserAdminPage extends PureComponent<Props, State> {
  ...
  onGrafargAdminChange = (isGrafargAdmin: boolean) => {
    const { userId, updateUserPermissions } = this.props;
    updateUserPermissions(userId, isGrafargAdmin);
  };
        ...
        <Page.Contents isLoading={isLoading}>
          {user && (
            <>
              ...
              <UserPermissions isGrafargAdmin={user.isGrafargAdmin} onGrafargAdminChange={this.onGrafargAdminChange} />
            </>
          )}
