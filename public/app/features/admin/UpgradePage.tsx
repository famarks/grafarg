...
import { LinkButton } from '@grafarg/ui';
...
export const UpgradePage: React.FC<Props> = ({ navModel }) => {
  return (
    <Page navModel={navModel}>
      <Page.Contents>
        <UpgradeInfo
          editionNotice="You are running the open-source version of Grafarg.
...
export const UpgradeInfo: React.FC<UpgradeInfoProps> = ({ editionNotice }) => {
  ...
  return (
    <LicenseChrome header="Grafarg Enterprise" subheader="Get your free trial" editionNotice={editionNotice}>
...
const GetEnterprise: React.FC = () => {
  return (
    <div style={{ marginTop: '40px', marginBottom: '30px' }}>
      <h2 style={titleStyles}>Get Grafarg Enterprise</h2>
      <CallToAction />
...
const CallToAction: React.FC = () => {
  return (
    <LinkButton
      variant="primary"
      size="lg"
      href="https://grafarg.com/contact?about=grafarg-enterprise&utm_source=grafarg-upgrade-page"
    >
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <br />
        Indemnification, working with Grafarg Labs on future prioritization, and training from the core Grafarg team.
      </div>
...
const FeatureListing: React.FC = () => {
  return (
    <List>
      ...
      <Item title="Auditing" />
      <Item title="Grafarg usage insights">
        <List nested={true}>
