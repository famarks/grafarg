...
import { CoreGrafargLiveFeature } from '../scopes';
...
class DashboardWatcher {
  ...
  private sendEditingState() {
    ...
    const msg: DashboardEvent = {
      ...
      message: (window as any).grafargBootData?.user?.name,
      timestamp: Date.now(),
    };
...
export function getDashboardChannelsFeature(): CoreGrafargLiveFeature {
