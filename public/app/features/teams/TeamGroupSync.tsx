...
import { LegacyForms, Tooltip, Icon } from '@grafarg/ui';
...
const headerTooltip = `Sync LDAP or OAuth groups with your Grafarg teams.`;
      ...
      <div>
            ...
            <form className="gf-form-inline" onSubmit={this.onAddGroup}>
              <div className="gf-form">
                <Input
                  ...
                  placeholder="cn=ops,ou=groups,dc=grafarg,dc=org"
                />
              </div>
        ...
        {groups.length === 0 && !isAdding && (
          <EmptyListCTA
            ...
            proTipLink="http://docs.grafarg.org/auth/enhanced_ldap/"
            proTipTarget="_blank"
          />
        )}
