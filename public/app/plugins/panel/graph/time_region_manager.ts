...
import { getColorForTheme, dateTime, DateTime, AbsoluteTimeRange, GrafargTheme } from '@grafarg/data';
...
function getColor(timeRegion: any, theme: GrafargTheme): TimeRegionColorDefinition {
