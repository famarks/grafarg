import { FieldColorModeId, FieldConfigProperty, FieldMatcherID, PanelModel } from '@grafarg/data';
import { LegendDisplayMode, PieChartLabels } from '@grafarg/ui';
...
describe('PieChart -> PieChartV2 migrations', () => {
  ...
  it('correctly assigns color overrides', () => {
    ...
    PieChartPanelChangedHandler(panel, 'grafarg-piechart-panel', oldPieChartOptions);
  ...
  it('correctly sets sum calculation', () => {
    ...
    const options = PieChartPanelChangedHandler(panel, 'grafarg-piechart-panel', oldPieChartOptions);
