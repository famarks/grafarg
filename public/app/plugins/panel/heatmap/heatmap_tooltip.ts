...
import { getValueFormat, formattedValueToString } from '@grafarg/data';
...
export class HeatmapTooltip {
  ...
  add() {
    this.tooltip = d3.select('body').append('div').attr('class', 'heatmap-tooltip graph-tooltip grafarg-tooltip');
  }
