...
const scopes: Array<SelectableValue<LiveChannelScope>> = [
  { label: 'Grafarg', value: LiveChannelScope.Grafarg, description: 'Core grafarg live features' },
...
export class LiveChannelEditor extends PureComponent<Props, State> {
  ...
  async updateSelectOptions() {
    ...
    const srv = getGrafargLiveCentrifugeSrv();
  ...
  render() {
    ...
    return (
      <>
        <FeatureInfoBox title="Grafarg Live" featureState={FeatureState.alpha}>
          <p>
