  ...
  return (
    <div className={styles.card}>
      <div className={cardContent}>
        <a href={`${card.href}?utm_source=grafarg_gettingstarted`}>
      ...
      <a
        href={`${card.learnHref}?utm_source=grafarg_gettingstarted`}
...
const getStyles = stylesFactory((theme: GrafargTheme, complete: boolean) => {
  return {
    card: css`
