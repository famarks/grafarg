...
export const ConfigEditor: FC<Props> = (props: Props) => {
  ...
  useEffect(() => {
    ...
    if (props.options.jsonData.authType === 'arn') {
      addWarning('Since grafarg 7.3 authentication type "arn" is deprecated, falling back to default SDK provider');
    } else if (
      ...
      addWarning(
        'As of grafarg 7.3 authentication type "credentials" should be used only for shared file credentials. \
