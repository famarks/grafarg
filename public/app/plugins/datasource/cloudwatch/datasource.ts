...
const LOG_IDENTIFIER_INTERNAL = '__log__grafarg_internal__';
const LOGSTREAM_IDENTIFIER_INTERNAL = '__logstream__grafarg_internal__';
  ...
  handleLiveLogQueries = (
    ...
    return this.awsRequest(TSDB_QUERY_ENDPOINT, requestParams).pipe(
      mergeMap((response: TSDBResponse) => {
        ...
        const channel = getGrafargLiveSrv().getChannel({
