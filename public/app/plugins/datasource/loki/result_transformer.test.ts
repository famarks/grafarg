import { CircularDataFrame, FieldCache, FieldType, MutableDataFrame } from '@grafarg/data';
import {
  LokiStreamResult,
  LokiTailResponse,
  LokiStreamResponse,
    ...
    it('should return a dataframe with ts in iso format', () => {
      const tailResponse: LokiTailResponse = {
        streams: [
          {
            stream: {
              filename: '/var/log/grafarg/grafarg.log',
              job: 'grafarg',
            },
            values: [
              [
                '1581519914265798400',
                't=2020-02-12T15:04:51+0000 lvl=info msg="Starting Grafarg" logger=server version=6.7.0-pre commit=6f09bc9fb4 branch=issue-21929 compiled=2020-02-11T20:43:28+0000',
              ],
            ],
          },
        ],
      ...
      data.addField({ name: 'line', type: FieldType.string }).labels = { job: 'grafarg' };
      ...
      expect(data.get(0)).toEqual({
        ...
        line:
          't=2020-02-12T15:04:51+0000 lvl=info msg="Starting Grafarg" logger=server version=6.7.0-pre commit=6f09bc9fb4 branch=issue-21929 compiled=2020-02-11T20:43:28+0000',
        labels: { filename: '/var/log/grafarg/grafarg.log' },
