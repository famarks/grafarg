...
import { GrafargLiveEditor } from './components/GrafargLiveEditor';
...
export const QueryEditor = ({ query, datasource, onChange, onRunQuery }: Props) => {
  ...
  return (
    <>
      ...
      {scenarioId === 'live' && <GrafargLiveEditor onChange={onUpdate} query={query} />}
      {scenarioId === 'logs' && (
        <InlineFieldRow>
