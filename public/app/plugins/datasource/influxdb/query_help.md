...
#### Group by time
- Group by time is important, otherwise the query could return many thousands of datapoints that will slow down Grafarg
...
[Grafarg's InfluxDB Documentation](http://docs.grafarg.org/features/datasources/influxdb)
