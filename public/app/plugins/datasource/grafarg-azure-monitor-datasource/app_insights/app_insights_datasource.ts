import { DataQueryRequest, DataSourceInstanceSettings, ScopedVars, MetricFindValue } from '@grafarg/data';
import { getBackendSrv, getTemplateSrv, DataSourceWithBackend } from '@grafarg/runtime';
...
export default class AppInsightsDatasource extends DataSourceWithBackend<AzureMonitorQuery, AzureDataSourceJsonData> {
   ...
   * because it's not exposed to Grafarg like the main AzureMonitorDataSource.
