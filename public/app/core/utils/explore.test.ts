...
import { DataQueryError, dateTime, ExploreUrlState, LogsSortOrder } from '@grafarg/data';
...
describe('state functions', () => {
  describe('parseUrlState', () => {
    ...
    it('should not return a query for mode in the url', () => {
      // Previous versions of Grafarg included "Explore mode" in the URL; this should not be treated as a query.
      const paramValue =
...
describe('updateHistory()', () => {
  ...
  const key = `grafarg.explore.history.${datasourceId}`;
