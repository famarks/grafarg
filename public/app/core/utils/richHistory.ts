...
export const RICH_HISTORY_SETTING_KEYS = {
  retentionPeriod: 'grafarg.explore.richHistory.retentionPeriod',
  starredTabAsFirstTab: 'grafarg.explore.richHistory.starredTabAsFirstTab',
  activeDatasourceOnly: 'grafarg.explore.richHistory.activeDatasourceOnly',
  datasourceFilters: 'grafarg.explore.richHistory.datasourceFilters',
};
