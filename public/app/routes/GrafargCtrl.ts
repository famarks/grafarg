...
import { AppEvent, AppEvents, locationUtil } from '@grafarg/data';
import { backendSrv } from 'app/core/services/backend_srv';
import { initGrafargLive } from 'app/features/live/live';

export type GrafargRootScope = IRootScopeService & AppEventEmitter & AppEventConsumer & { colors: string[] };

export class GrafargCtrl {
  /** @ngInject */
  constructor(
    $scope: any,
    utilSrv: UtilSrv,
...
/** @ngInject */
export function grafargAppDirective(
...
coreModule.directive('grafargApp', grafargAppDirective);
