...
import { RawTimeRange, PanelPluginMeta, dateMath } from '@grafarg/data';
...
export function ControllerTestContext(this: any) {
  ...
  this.createPanelController = (Ctrl: any) => {
    return angularMocks.inject(($controller: any, $rootScope: GrafargRootScope, $location: any, $browser: any) => {
...
export function ServiceTestContext(this: any) {
  ...
  this.createService = (name: string) => {
    ...
    return angularMocks.inject(
      ($rootScope: GrafargRootScope, $httpBackend: any, $injector: any, $location: any, $timeout: any) => {
...
export function TemplateSrvStub(this: any) {
  ...
  this.setGrafargVariable = function (name: string, value: string) {
