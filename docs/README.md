...
Generally, someone from marketing will publish to production each day: so as long as the sync is successful your docs edits will be published. Alternatively, you can refer to [publishing to production](https://github.com/famarks/website#publishing-to-production-grafargcom) if you'd like to do it yourself.
