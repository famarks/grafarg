...
keywords = ["grafarg", "http", "documentation", "api", "licensing", "enterprise"]
aliases = ["/docs/grafarg/latest/http_api/licensing/"]
+++

# Enterprise License API

Licensing is only available in Grafarg Enterprise. Read more about [Grafarg Enterprise]({{< relref "../enterprise" >}}).
...
{
  "jti":"2",
  "iss":"https://grafarg.com",
  "sub":"https://play.grafarg.org/"
  "lid":"1",
  "included_admins":5,
  "included_viewers":10,
  ...
  "tok_exp_warn_days":2,
  "update_days":1,
  "prod":["grafarg-enterprise"],
  "company":"Grafarg Labs"
}
```
...
Removes the license stored in the Grafarg database.
...
{"instance": "http://play.grafarg.org/"}
```
