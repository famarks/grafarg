...
keywords = ["grafarg", "http", "documentation", "api", "datasource", "permission", "permissions", "acl", "enterprise"]
aliases = ["/docs/grafarg/latest/http_api/datasourcepermissions/"]
+++

# Data Source Permissions API

> The Data Source Permissions is only available in Grafarg Enterprise. Read more about [Grafarg Enterprise]({{< relref "../enterprise" >}}).
