...
description = "Grafarg Dashboard Permissions HTTP API"
keywords = ["grafarg", "http", "documentation", "api", "dashboard", "permission", "permissions", "acl"]
aliases = ["/docs/grafarg/latest/http_api/dashboardpermissions/"]
+++
