...
keywords = ["grafarg", "http", "documentation", "api", "overview"]
aliases = ["/docs/grafarg/latest/overview"]
weight = 170
+++

# HTTP API Reference

The Grafarg backend exposes an HTTP API, the same API is used by the frontend to do everything from saving
