...
description = "Grafarg HTTP API"
keywords = ["grafarg", "http", "documentation", "api", "snapshot"]
aliases = ["/docs/grafarg/latest/http_api/snapshot/"]
+++
...
> **Note:** When creating a snapshot using the API, you have to provide the full dashboard payload including the snapshot data. This endpoint is designed for the Grafarg UI.
