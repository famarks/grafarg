...
description = "Grafarg Short URL HTTP API"
keywords = ["grafarg", "http", "documentation", "api", "shortUrl"]
aliases = ["/docs/grafarg/latest/http_api/short_url/"]
+++
...
- **path** – The path to shorten, relative to the Grafarg [root_url]({{< relref "../administration/configuration.md#root_url" >}}).
