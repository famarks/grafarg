...
description = "Grafarg Alerts HTTP API"
keywords = ["grafarg", "http", "documentation", "api", "alerting", "alerts"]
aliases = ["/docs/grafarg/latest/http_api/alerting/"]
+++
...
[
  {
    ...
    "evalData": null,
    "executionError": "",
    "url": "http://grafarg.com/dashboard/db/sensors"
  }
]
```
