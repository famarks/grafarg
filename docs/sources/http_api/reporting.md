+++
title = "Reporting API"
description = "Grafarg Enterprise APIs"
keywords = ["grafarg", "enterprise", "api", "reporting"]
aliases = ["/docs/grafarg/latest/http_api/reporting/"]
+++
...
> Reporting is only available in Grafarg Enterprise. Read more about [Grafarg Enterprise]({{< relref "../enterprise" >}}).
...
> This API endpoint is experimental and may be deprecated in a future release. On deprecation, a migration strategy will be provided and the endpoint will remain functional until the next major release of Grafarg.
