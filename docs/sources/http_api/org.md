...
description = "Grafarg Organization HTTP API"
keywords = ["grafarg", "http", "documentation", "api", "organization"]
aliases = ["/docs/grafarg/latest/http_api/organization/"]
+++
...
Mainly used by Grafarg UI for providing list of users when adding team members and
...
use Basic Auth and the Grafarg user must have the Grafarg Admin permission (The default admin user
