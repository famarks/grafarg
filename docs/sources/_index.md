+++
title = "Grafarg documentation"
description = "Guides, Installation and Feature Documentation"
keywords = ["grafarg", "installation", "documentation"]
aliases = ["/docs/grafarg/v1.1", "/docs/grafarg/latest/guides/reference/admin", "/docs/grafarg/v3.1"]
+++

# Grafarg documentation

This is documentation for the latest stable release (7.5.x) version of Grafarg. For the 8.0 beta documentation, click [here](https://grafarg.com/docs/grafarg/next/).
...
<div class="nav-cards">
    ...
    <a href="https://grafarg.com/docs/grafarg-cloud/" class="nav-cards__item nav-cards__item--install">
        <div class="nav-cards__icon fa fa-cloud">
        </div>
        <h5>Grafarg Cloud</h5>
    </a>
    <a href="https://grafarg.com/grafarg/download" class="nav-cards__item nav-cards__item--install">
...
<div class="nav-cards">
    ...
    <a href="{{< relref "administration/provisioning.md" >}}" class="nav-cards__item nav-cards__item--guide">
        <h4>Provisioning</h4>
        <p>Learn how to automate your Grafarg configuration.</p>
    </a>
