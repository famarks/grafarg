...
aliases = ["/docs/grafarg/latest/variables/add-constant-variable.md"]
weight = 400
+++
...
1. In **Preview of values**, Grafarg displays the current variable value. Review it to ensure it matches what you expect.
