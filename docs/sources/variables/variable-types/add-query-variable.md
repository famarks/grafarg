...
aliases = ["/docs/grafarg/latest/variables/add-query-variable.md"]
weight = 100
+++
...
Query expressions can contain references to other variables and in effect create linked variables. Grafarg detects this and automatically refreshes a variable when one of its linked variables change.
