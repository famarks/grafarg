...
These can be especially useful for administrators who want to allow Grafarg viewers to quickly adjust visualizations but do not want to give them full editing permissions. Grafarg Viewers can use variables.
