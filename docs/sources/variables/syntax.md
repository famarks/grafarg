...
aliases = ["/docs/grafarg/latest/reference/templating"]
weight = 100
+++
...
- `${var_name:<format>}` This format gives you more control over how Grafarg interpolates values. Refer to [Advanced variable format options]({{< relref "advanced-variable-format-options.md" >}}) for more detail on all the formatting types.
