...
> **Note:** This is an experimental feature that will be deprecated in Grafarg v8.
...
To see an example, check out [Templating value groups](https://play.grafarg.org/d/000000024/templating-value-groups?orgId=1).
...
In this [example dashboard](https://play.grafarg.org/d/ZUPhFVGGk/graphite-with-experimental-tags?orgId=1), the server variable has tags enabled.
