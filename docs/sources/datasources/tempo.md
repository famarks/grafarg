+++
title = "Tempo"
description = "High volume, minimal dependency trace storage. OSS tracing solution from Grafarg Labs."
keywords = ["grafarg", "tempo", "guide", "tracing"]
aliases = ["/docs/grafarg/latest/features/datasources/tempo"]
weight = 1400
+++

# Tempo data source

Grafarg ships with built-in support for Tempo a high volume, minimal dependency trace storage, OSS tracing solution from Grafarg Labs. Add it as a data source, and you are ready to query your traces in [Explore]({{< relref "../explore/_index.md" >}}).
