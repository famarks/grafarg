...
aliases = ["/docs/grafarg/latest/features/datasources/add-a-data-source/"]
weight = 100
+++
...
1. Move your cursor to the cog on the side menu which will show you the configuration menu. If the side menu is not visible click the Grafarg icon in the upper left corner. Click on **Configuration** > **Data sources** in the side menu and you'll be taken to the data sources page
...
1. Click on **Data Sources**. The data sources page opens showing a list of previously configured data sources for the Grafarg instance.
