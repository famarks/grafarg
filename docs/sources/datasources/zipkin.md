+++
title = "Zipkin"
description = "Guide for using Zipkin in Grafarg"
keywords = ["grafarg", "zipkin", "guide", "tracing"]
aliases = ["/docs/grafarg/latest/datasources/zipkin"]
weight = 1600
+++

# Zipkin data source

Grafarg ships with built-in support for Zipkin, an open source, distributed tracing system.
