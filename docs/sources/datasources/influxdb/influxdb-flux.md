+++
title = "Flux support in Grafarg"
description = "Guide for Flux in Grafarg"
weight = 200
+++

# Flux query language in Grafarg

Grafarg supports Flux running on InfluxDB 1.8+.  See [1.8 compatibility](https://github.com/influxdata/influxdb-client-go/#influxdb-18-api-compatibility) for more information and connection details.
