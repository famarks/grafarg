...
keywords = ["grafarg", "intro", "guide", "concepts", "methods"]
aliases = ["/docs/grafarg/latest/getting-started/strategies/"]
weight = 300
+++
...
For more information, refer to Tom Wilkie's blog post [The RED method: How to instrument your services](https://grafarg.com/blog/2018/08/02/the-red-method-how-to-instrument-your-services).
...
[Here's an example from Grafarg Play](https://play.grafarg.org/d/000000109/the-four-golden-signals?orgId=1).
