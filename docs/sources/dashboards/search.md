+++
title = "Search"
keywords = ["grafarg", "dashboard", "documentation", "search"]
aliases =["/docs/grafarg/latest/reference/search/"]
weight = 5
+++
...
> **Note:** When multiple tags are selected, Grafarg will show dashboards that include **all**.
