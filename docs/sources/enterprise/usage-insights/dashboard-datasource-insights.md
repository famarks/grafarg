...
aliases = ["/docs/grafarg/latest/enterprise/usage-insights/dashboard-datasource-insights.md"]
weight = 200
+++
...
> **Note:** Available in Grafarg Enterprise v7.0+.
...
> **Note:** Available in Grafarg Enterprise v7.3+.
