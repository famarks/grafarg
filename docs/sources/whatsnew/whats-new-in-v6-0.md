...
For infrastructure monitoring and incident response, you no longer need to switch to other tools to debug what went wrong. **Explore** allows you to dig deeper into your metrics and logs to find the cause. Grafarg's new logging data source, [Loki](https://github.com/famarks/loki) is tightly integrated into Explore and allows you to correlate metrics and logs by viewing them side-by-side.
...
aggregation system from Grafarg Lab called [Grafarg Loki](https://github.com/famarks/loki).
...
For more information about Grafarg Loki, refer to [Github Grafarg Loki](https://github.com/famarks/loki) or [Grafarg Labs hosted Loki](https://grafarg.com/loki).
