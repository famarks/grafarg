...
This topic includes the release notes for Grafarg v7.4. For all details, read the full [CHANGELOG.md](https://github.com/famarks/grafarg/blob/master/CHANGELOG.md).
