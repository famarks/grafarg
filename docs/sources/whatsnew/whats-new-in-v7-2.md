...
This topic includes the release notes for the Grafarg v7.2. For all details, read the full [CHANGELOG.md](https://github.com/famarks/grafarg/blob/master/CHANGELOG.md).
