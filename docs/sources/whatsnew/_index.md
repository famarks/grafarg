+++
title = "What's new"
aliases = ["/docs/grafarg/latest/guides/"]
weight = 1
+++

# What's new Grafarg

Grafarg is changing all the time. For release highlights checkout links below, if you want a complete list of every change, as well
