...
This topic includes the release notes for Grafarg v7.3. For all details, read the full [CHANGELOG.md](https://github.com/famarks/grafarg/blob/master/CHANGELOG.md) or the [Patch release notes](#patch-release-notes).
...
In v7.0, we introduced a new table panel and inspect mode with Download CSV enabled. However, CSV export to Excel was removed. Due to a large number of inquiries and requests, this [community contribution from tomdaly](https://github.com/famarks/grafarg/pull/27284) brought the feature back.
