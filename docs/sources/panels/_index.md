+++
title = "Panels"
aliases = ["/docs/grafarg/latest/features/panels/panels/"]
weight = 70
+++

# Panel overview

The *panel* is the basic visualization building block in Grafarg. Each panel has a query editor specific to the data source selected in the panel. The query editor allows you to extract the perfect visualization to display on the panel.
