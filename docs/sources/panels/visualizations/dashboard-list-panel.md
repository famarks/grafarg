...
keywords = ["grafarg", "dashboard list", "documentation", "panel", "dashlist"]
aliases = ["/docs/grafarg/latest/reference/dashlist/", "/docs/grafarg/latest/features/panels/dashlist/"]
weight = 300
+++
