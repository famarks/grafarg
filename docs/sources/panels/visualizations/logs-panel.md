+++
title = "Logs panel"
keywords = ["grafarg", "dashboard", "documentation", "panels", "logs panel"]
aliases = ["/docs/grafarg/latest/reference/logs/", "/docs/grafarg/latest/features/panels/logs/",]
weight = 700
+++
...
> **Note:** The Logs panel is only available in Grafarg v6.4+.
