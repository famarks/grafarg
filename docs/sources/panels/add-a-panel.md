...
Grafarg creates an empty graph panel with your default data source selected.
...
In the Visualization section of the Panel tab, click a visualization type. Grafarg displays a preview of your query results with that visualization applied.
...
Our Grafarg Fundamentals tutorial is a great place to start, or you can learn more about Grafarg by reading one of the documentation topics linked below:
