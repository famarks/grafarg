...
Grafarg comes with the following transformations:
...
> **Note:** This transformation is available in Grafarg 7.1+.
...
Grafarg displays the **Identifier** field, followed by the fields returned by your query.
...
Grafarg displays the query identification letters in dark gray text. Click a query identifier to toggle filtering. If the query letter is white, then the results are displayed. If the query letter is dark, then the results are hidden.
...
Grafarg displays a list of fields returned by the query. You can:
...
> **Note:** This transformation is available in Grafarg 7.4+.
...
> **Note:** This transformation is available in Grafarg 7.2+.
...
> **Note:** This transformation is available in Grafarg 7.3+.
...
This transformation allows you to filter your data directly in Grafarg and remove some data points from your query result. You have the option to include or exclude data that match one or more conditions you define. The conditions are applied on a selected field.
...
> **Note:** This transformation is available in Grafarg 7.5.10+ and Grafarg 8.0.6+.
