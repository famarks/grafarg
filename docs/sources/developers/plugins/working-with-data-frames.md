...
The data frame is a columnar data structure which allows efficient querying of large amounts of data. Since data frames are a central concept when developing plugins for Grafarg, in this guide we'll look at some ways you can use them.
...
[Field options]({{< relref "../../panels/field-options/_index.md" >}}) let the user control how Grafarg displays the data in a data frame.
