...
> **Note:** Grafarg displays the exception message in the UI as written, so we recommend using grammatically correct sentences. For more information, refer to the [Documentation style guide](https://github.com/famarks/grafarg/blob/master/contribute/style-guides/documentation-style-guide.md).
