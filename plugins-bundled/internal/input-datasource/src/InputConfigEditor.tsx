...
import { TableInputCSV } from '@grafarg/ui';
import { DataSourcePluginOptionsEditorProps, DataFrame, MutableDataFrame } from '@grafarg/data';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="grafarg-info-box">
