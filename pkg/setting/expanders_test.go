...
func TestExpanderRegex(t *testing.T) {
	tests := map[string][][]string{
		...
		"$__file{C:\\Program Files\\grafarg\\something}": {{"__file", "C:\\Program Files\\grafarg\\something"}},

		// complex cases
		"get variable from $__env{ENV}ironment":               {{"__env", "ENV"}},
		"$__env{VAR1} $__file{/var/lib/grafarg/secrets/var1}": {{"__env", "VAR1"}, {"__file", "/var/lib/grafarg/secrets/var1"}},
