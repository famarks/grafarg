...
This directory contains guides for contributors to the Grafarg project.
...
The `style-guides` directory contains style guides for the Grafarg software project and documentation.
...
- [Redux framework](style-guides/redux.md) for designing the Grafarg redux framework.
- [Themes style guide](style-guides/themes.md) for designing and updating Grafarg themes.
