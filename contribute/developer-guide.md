...
1. Open a terminal and run `git clone https://github.com/famarks/grafarg.git`. This command downloads Grafarg to a new `grafarg` directory in your current directory.
