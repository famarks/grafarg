...
- _Do not_ use image shortcodes. Follow the guidance in the [Grafarg markdown guide](https://github.com/famarks/grafarg/blob/master/contribute/style-guides/documentation-markdown-guide.md#images).
