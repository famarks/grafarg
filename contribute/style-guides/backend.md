...
- [revive](https://revive.run/) with a [custom config](https://github.com/famarks/grafarg/blob/master/conf/revive.toml)
...
technical reasons. See this [comment](https://github.com/famarks/grafarg/issues/3269#issuecomment-383328548) by Torkel 
for context.
